...
echo ""
echo "  $DOCKER run --rm -v \"\$(pwd)/recordings:/app/recordings\" telemost-recorder \"https://telemost.yandex.ru/j/ВАШ_ID\""
echo ""
echo "С отладкой:"
echo ""
echo "  $DOCKER run --rm -v \"\$(pwd)/recordings:/app/recordings\" telemost-recorder \"https://telemost.yandex.ru/j/ВАШ_ID\" --debug"
echo ""
